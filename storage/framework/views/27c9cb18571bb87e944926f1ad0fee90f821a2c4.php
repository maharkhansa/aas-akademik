...
<body class="hold-transition login-page" style="background-image: url('<?php echo e(asset("img/wallup.jpg")); ?>'); background-size: cover; background-attachment: fixed;">
  <div class="login-box">
    <div class="login-logo">
      <img src="<?php echo e(asset('img/logosiakad.png')); ?>" width="100%" alt="">
    </div>
...
<?php /**PATH C:\laragon\www\Sistem-Informasi-Akademik-Sekolah-Laravel\resources\views/layouts/app.blade.php ENDPATH**/ ?>