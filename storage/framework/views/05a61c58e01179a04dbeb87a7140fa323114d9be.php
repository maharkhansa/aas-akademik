<?php $__env->startSection('heading', 'Data Kelas'); ?>
          ...
          <table id="example1" class="table table-bordered table-striped table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form action="<?php echo e(route('kelas.destroy', $data->id)); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('delete'); ?>
                            <button type="button" class="btn btn-info btn-sm" onclick="getSubsSiswa(<?php echo e($data->id); ?>)" data-toggle="modal" data-target=".view-siswa">
                              <i class="nav-icon fas fa-users"></i> &nbsp; View Siswa
                            </button>
                            <button type="button" class="btn btn-info btn-sm" onclick="getSubsJadwal(<?php echo e($data->id); ?>)" data-toggle="modal" data-target=".view-jadwal">
                              <i class="nav-icon fas fa-calendar-alt"></i> &nbsp; View Jadwal
                            </button>
                            <button type="button" class="btn btn-success btn-sm" onclick="getEditKelas(<?php echo e($data->id); ?>)" data-toggle="modal" data-target="#form-kelas">
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="form-group">
                ...
                <select id="guru_id" name="guru_id" class="select2bs4 form-control <?php $__errorArgs = ['guru_id'];
  ...
  <script>
    function getCreateKelas(){
      ...
      $('#form_nama').html(`
        ...
        <input type='text' id="nama_kelas" onkeyup="this.value = this.value.toUpperCase()" name='nama_kelas' class="form-control <?php $__errorArgs = ['nama_kelas'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="<?php echo e(__('Nama Kelas')); ?>">
      ...
      $('#form_paket').html(`
        ...
        <select id="paket_id" name="paket_id" class="select2bs4 form-control <?php $__errorArgs = ['paket_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
    ...
    function getEditKelas(id){
      ...
      $.ajax({
        ...
        data:"id="+parent,
        dataType:"JSON",
        url:"<?php echo e(url('/kelas/edit/json')); ?>",
    ...
    function getSubsSiswa(id){
      ...
      $.ajax({
        ...
        data:"id="+parent,
        dataType:"JSON",
        url:"<?php echo e(url('/siswa/view/json')); ?>",
        success:function(result){
          // console.log(result);
          var siswa = "";
          if(result){
    ...
    function getSubsJadwal(id){
      ...
      $.ajax({
        ...
        data:"id="+parent,
        dataType:"JSON",
        url:"<?php echo e(url('/jadwal/view/json')); ?>",
        success:function(result){
          // console.log(result);
          var jadwal = "";
          if(result){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template_backend.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Sistem-Informasi-Akademik-Sekolah-Laravel\resources\views/admin/kelas/index.blade.php ENDPATH**/ ?>