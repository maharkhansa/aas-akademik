...
<body class="hold-transition login-page" style="background-image: url('<?php echo e(asset("img/umm.jpg")); ?>'); background-size: cover; background-attachment: fixed;">
  <div class="login-box">
    <div class="login-logo">
      <img src="<?php echo e(asset('img/logounimma.png')); ?>" width="100%" alt="">
    </div>
    ...
    <footer style="color: white;">
      <marquee>
          <strong>Copyright &copy; <script>document.write(new Date().getFullYear());</script> &diams; <a href="https://unimma.ac.id/" style="color: blue;">Universitas Muhammadiyah Magelang</a>. </strong>
      </marquee>
    </footer>
  </div>
...
<?php /**PATH C:\xampp7\htdocs\akademik\resources\views/layouts/app.blade.php ENDPATH**/ ?>